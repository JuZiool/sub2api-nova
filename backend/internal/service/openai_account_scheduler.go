...
func (s *OpenAIGatewayService) ReportOpenAIAccountScheduleResult(accountOrID any, model string, success bool, firstTokenMs *int, extras ...any) bool {
	var (
		account     *Account
		accountID   int64
	...
	for _, extra := range extras {
		...
		case context.Context:
			requestCtx = append(requestCtx, value)
		case error:
			if value != nil {
				observedErr = value
			}
