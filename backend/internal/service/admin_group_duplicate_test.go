...
func TestDuplicateGroupCopiesConfigurationDeeplyAndResetsRuntimeState(t *testing.T) {
	...
	source := &Group{
		...
		ModelsListConfig:        GroupModelsListConfig{Enabled: true, Models: []string{"gpt-5.4", "gpt-5-mini"}, HiddenModels: []string{"gpt-5.5"}},
		RPMLimit:                99,
	...
	duplicate.ModelsListConfig.HiddenModels[0] = "changed-hidden"
	...
	*duplicate.DailyLimitUSD = 999
	...
	require.Equal(t, "gpt-5.5", source.ModelsListConfig.HiddenModels[0])
