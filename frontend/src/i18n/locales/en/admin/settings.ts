    ...
    settings: {
      ...
      features: {
        channelMonitor: {
          ...
          mode: 'Monitor mode',
          modeHint: 'Default is V2 (passive aggregation). Switch to V1 only when you need active upstream probes; only one implementation can be active at a time.',
          modeV2: 'V2 passive monitoring',
          modeV1: 'V1 active probes',
          modeV2Hint: 'Default: aggregates health metrics from real gateway traffic without upstream probe traffic. V1 probes stop while V2 is active.',
      ...
      site: {
        ...
        siteName: 'Site Name',
        siteNamePlaceholder: 'Sub2API Nova',
      ...
      smtp: {
        ...
        fromName: 'From Name',
        fromNamePlaceholder: 'Sub2API Nova',
        useTls: 'Use TLS',
