export default {
    ...
    users: {
      ...
      form: {
        ...
        concurrencyPlaceholder: '0 means unlimited',
        concurrencyHint: 'Maximum concurrent requests for this user, 0 = unlimited',
      ...
      concurrencyNonNegative: 'Concurrency cannot be negative; 0 means unlimited',
