<template>
  ...
  >
    ...
    <div class="sidebar-header" :class="{ 'sidebar-header-collapsed': sidebarCollapsed }">
      ...
      >
        <img v-if="settingsLoaded" :src="siteLogo || '/nova-icon-512.png'" alt="Logo" class="h-full w-full object-contain" />
      </router-link>
    ...
    <!-- Bottom Section -->
    <div class="mt-auto border-t border-primary-100 p-3 dark:border-dark-800">
      <!-- Collapse Button -->
      <button
        @click="toggleSidebar"
...
const adminNavItems = computed((): NavItem[] => {
  ...
  if (authStore.isSimpleMode) {
    ...
    filtered.push({ path: '/admin/backups', label: t('nav.dataBackupRestore'), icon: DatabaseIcon })
  ...
  visible.push({ path: '/admin/backups', label: t('nav.dataBackupRestore'), icon: DatabaseIcon })
  for (const cm of customMenuItemsForAdmin.value) {
